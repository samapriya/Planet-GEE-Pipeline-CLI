...
setuptools.setup(
    ...
    install_requires=['bs4>=0.0.1','clipboard>=0.0.4','earthengine-api>=0.1.138','future>=0.16.0',
                  'google-cloud-storage>=1.5.0','planet>=1.1.0','pandas>=0.23.0','psutil>=5.4.5',
                  'pyOpenSSL>=19.0.0','pyshp>=1.2.12','pytest>=3.5.1','requests-toolbelt>=0.8.0','retrying>=1.3.3','simplejson>=3.15.0','selenium>=3.13.0','pySmartDL>=1.2.5','pathlib>=1.0.1','lxml>=4.1.1',
