...
def authenticate():
    ...
    try:
        ...
        time.sleep(5)
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='terms of service'])[1]/following::span[2]"
        ).click()
        time.sleep(3)
        driver.find_element_by_id("profileIdentifier").click()
        time.sleep(2)
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='Earth Engine Code Editor'])[1]/following::div[13]"
        ).click()
